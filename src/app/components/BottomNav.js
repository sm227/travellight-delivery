  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 flex justify-around items-center h-16 z-10">
      <button 
        ...
        className={`flex flex-col items-center justify-center w-1/5 h-full ${currentStep === 'map' ? 'text-blue-600' : 'text-gray-500'}`}
      >
      ...
      <button 
        ...
        className={`flex flex-col items-center justify-center w-1/5 h-full ${currentStep === 'mode' ? 'text-blue-600' : 'text-gray-500'}`}
      >
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <button 
        ...
        className={`flex flex-col items-center justify-center w-1/5 h-full ${currentStep === 'start' ? 'text-blue-600' : 'text-gray-500'}`}
      >
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <button 
        className={`flex flex-col items-center justify-center w-1/5 h-full ${['pickup', 'delivery'].includes(currentStep) ? 'text-blue-600' : 'text-gray-500'}`}
      ...
      <button 
        ...
        className={`flex flex-col items-center justify-center w-1/5 h-full ${isWorking ? 'text-red-600' : 'text-gray-300'}`}
        disabled={!isWorking}
      >
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
